...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th10 15, 2018 lúc 03:22 PM
-- Phiên bản máy phục vụ: 10.3.8-MariaDB
-- Phiên bản PHP: 7.2.9
...
(2, '2018-11-15', 251000, 10000000, 25100, '2018-11-15 04:17:27', '2018-11-15 04:22:50');
...
(1, '2018-11', 586000, 10000000, 32100, '2018-11-14 02:19:05', '2018-11-15 04:22:50');
...
(1, 1, 'HH2 Bắc Hà, 19, 441 Vũ Hữu, Trung Văn, Thanh Xuân, Hà Nội, Vietnam', '11a', NULL, '1541307633000', '1541271633000', 1, '70000', 0, 0, 1, 'Tran Thanh Tuan', 'tuantt@gmail.com', NULL, '[{\"package_id\":80,\"number\":2}]', NULL, '2018-11-03 10:47:44', '2018-11-04 20:20:54'),
...
(13, 1, 'HH2 Bắc Hà, 19, 441 Vũ Hữu, Trung Văn, Thanh Xuân, Hà Nội, Vietnam', '1102', NULL, '1541901635000', '1541901635000', 1, '265000', 0, 0, 1, 'Tran Thanh Tuan', 'tuantt@gmail.com', 'coupon20-10', '[{\"package_id\":80,\"number\":2},{\"package_id\":81,\"number\":2},{\"package_id\":84,\"number\":1},{\"package_id\":116,\"number\":2}]', NULL, '2018-11-10 23:06:36', '2018-11-12 03:40:41'),
...
(24, 1, 'HH2 Bắc Hà, 19, 441 Vũ Hữu, Trung Văn, Thanh Xuân, Hà Nội, Vietnam', '1102', NULL, '1541905225000', '1541905225000', 1, '70000', 0, 0, 1, 'Tran Thanh Tuan', 'tuantt@gmail.com', NULL, '[{\"package_id\":80,\"number\":2}]', NULL, '2018-11-11 00:39:54', '2018-11-12 03:40:36'),
(25, 7, 'Ngõ 310 Nghi Tàm, P. Tứ Liên, Quận Tây Hồ, Thành Phố Hà Nội, Vietnam', '8a/81', NULL, '1542132180000.0', '1542132180000.0', 1, '140000', 0, 0, 1, NULL, 'nvukien@gmail.com', NULL, '[{\"package_id\":84, \"number\":2},{\"package_id\":80, \"number\":2}]', NULL, '2018-11-13 15:04:31', '2018-11-13 15:04:58'),
(26, 28, 'Số 36 Ngõ 2, Định Công, Hoàng Mai, Hà Nội, Việt Nam', '4444444', NULL, '1542132053000', '1542132053000', 0, '70000', 0, 0, 1, 'aaaa', NULL, NULL, '[{\"package_id\":80,\"number\":1},{\"package_id\":84,\"number\":1}]', NULL, '2018-11-13 15:22:27', '2018-11-13 15:22:27'),
(27, 1, 'Tòa Nhà Tây Hà Tố Hữu, Hanoi, Hà Nội 100000, Việt Nam', '1102', NULL, '1542265217000', '1542265217000', 2, '251000', 10000000, 25100, 1, 'Tran Thanh Tuan', 'tuantt@gmail.com', 'HSP-00003', '[{\"package_id\":80,\"number\":2},{\"package_id\":84,\"number\":3},{\"package_id\":85,\"number\":2}]', NULL, '2018-11-15 04:16:41', '2018-11-15 04:22:50');
...
(277, 'Báo giá thực tế', NULL, NULL, NULL, '0', '1542122191.png', 218);
...
CREATE TABLE `pages` (
  ...
  `content_ja` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `content_ko` text COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, 'whyUse', '<p>HSP cam kết mang lại các giá trị tuyệt vời nhất, nâng tầm chất lượng cuộc sống.</p><p>Với HSP, khách hàng sẽ được trải nghiệm dịch vụ với các tiêu chí hàng đầu:</p><ol><li>Chế độ bảo hành cam kết lâu dài</li><li>An tâm về lý lịch của nhân viên dịch vụ</li><li>Nhân viên dịch vụ chu đáo, tận tâm</li><li>Giá dịch vụ niêm yết rõ ràng</li><li>Nhanh chóng, tiện lợi</li></ol>', '<p>aaa</p>', '<p>bbb</p>', '<p>ccc</p>'),
(2, 'bestPractices', '<p>Để trải nghiệm và được phục vụ tốt nhất, xin quý khách hàng vui lòng:</p><ol><li>Tải và sử dụng phiên bản mới nhất của ứng dụng</li><li>Đọc kỹ điều khoản sử dụng quy định đối với từng dịch vụ</li><li>Kiểm tra phần tin tức để nhận thông tin về mã khuyến mại</li><li>Chia sẻ mã giới thiệu của mình cho bạn bè để nhận tiền trực tiếp vào tài khoản</li><li>Trải nghiệm và phản hồi đến bộ phận hỗ trợ khi có vấn đề phát sinh hoặc cần hỗ trợ</li><li>Sử dụng tính năng chụp và gửi hóa đơn thực tế trong giao diện \"Việc đã làm\" để nhận đầy đủ quyền và nghĩa vụ chăm sóc, bảo hành từ HSP Việt Nam</li></ol><p>Chúng tôi luôn lắng nghe để phục vụ tốt hơn.</p>', '<p>&nbsp;</p>', '<p>&nbsp;</p>', '<p>&nbsp;</p>'),
(3, 'faqs', '<p>Hỏi / Đáp</p><p>&nbsp;</p><p>&nbsp;</p>', NULL, NULL, NULL),
(4, 'legal', '<p><strong>Điều khoản sử dụng dịch vụ</strong></p><p>Điều khoản chung:</p><ol><li>Quý khách vui lòng đặt dịch vụ trước ít nhất 3 giờ để chúng tôi có thể sắp xếp nhân viên phục vụ tốt nhất. Đối với những trường hợp cần gấp hoặc thời gian yêu cầu dịch vụ đặc biệt, Quý khách vui lòng liên hệ số hotline để được hỗ trợ nhanh nhất.</li><li>Công ty chúng tôi quản lý toàn bộ hồ sơ cá nhân của nhân viên và cam kết lý lịch rõ ràng tuyệt đối. Trước khi được ký hợp đồng, nhân viên công ty đều trải qua quy trình đào tạo nghiêm ngặt về tay nghề và các vấn đề liên quan đến đạo đức kinh doanh. Tuy nhiên, chúng tôi vẫn khuyến cáo Quý khách vui lòng kiểm tra đồ đạc, tư trang và đồ có giá trị trước khi cho để nhân viên vào phục vụ hoặc giao nhận đồ.</li><li>Với những trường hợp dịch vụ đòi hỏi xử lý khó nằm ngoài khả năng phục vụ nhân viên khi đến khảo sát thực tế tại địa điểm làm việc (đối với dịch vụ sửa chữa, vệ sinh công nghiệp), nhân viên sẽ báo cáo về công ty và chúng tôi sẽ liên lạc lại với Quý khách để đề xuất giải pháp.</li><li>Khi nhân viên đến khảo sát thực tế yêu cầu dịch vụ, nếu có phát sinh thêm hạng mục phục vụ và chi phí nằm ngoài yêu cầu dịch vụ ban đầu, Quý khách vui lòng thông báo chính xác chi phí phát sinh bằng cách sử dụng tính năng chụp và gửi hình hóa đơn thực tế trong giao diện \"Việc đã làm\" để nhận được quyền lợi chăm sóc và bảo hành từ HSP Việt Nam. (Bỏ qua nếu không phát sinh chi phí so với hóa đơn dịch vụ ban đầu)</li><li>Đối với khách hàng gửi yêu cầu dịch vụ nhiều hơn 3 lần mà không sử dụng / hủy yêu cầu dịch vụ sau khi nhân viên đến để phục vụ, chúng tôi xin được phép tạm ngừng dịch vụ.</li></ol><p>Điều khoản chi tiết:</p><p>1. &nbsp; &nbsp; Dịch vụ giặt ủi:</p><p>·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Quý khách nhận đồ sau 24-48 tiếng kể từ thời điểm bàn giao đồ bẩn.</p><p>·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Chăn ga gối đệm thời gian trả đồ muộn hơn từ 48-72 tiếng làm việc.</p><p>·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Một số đồ đặc biệt co giãn, dễ phai màu, chất liệu không đảm bảo, chúng tôi xin phép không nhận phục vụ.</p><p>·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; HSP Việt Nam có trách nhiệm đền bù mọi mất mát, hư hỏng xảy ra trong quá trình phục vụ, giá trị đền bù không vượt quá 10 lần giá trị dịch vụ.</p><p>2.&nbsp;&nbsp;&nbsp;&nbsp; Dịch vụ giúp việc nhà:</p><p>·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; HSP Việt Nam sẽ đền bù mọi hư hỏng đổ vỡ và rủi ro trong quá trình phục vụ khách hàng.</p><p>3.&nbsp;&nbsp;&nbsp;&nbsp; Dịch vụ vệ sinh công nghiệp:</p><p>·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Toàn bộ trang thiết bị, hóa chất cơ bản sẽ do nhân viên của HSP Việt Nam chuẩn bị. Đối với những yêu cầu đặc biệt, đòi hỏi phải có sự hỗ trợ của phương tiện hoặc hóa chất riêng, sau khi nhận được báo cáo từ nhân viên, chúng tôi sẽ liên lạc lại với Quý khách để đề xuất giải pháp.</p><p>4. &nbsp; &nbsp; Dịch vụ điều hòa:</p><p>·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Quý khách vui lòng để nhân viên kiểm tra và đánh giá một lượt sản phẩm xem có phát sinh lỗi ngoài yêu cầu hay không trước khi bắt đầu thực hiện dịch vụ.</p><p>·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Sửa chữa không thay thế linh, phụ kiện, HSP Việt Nam sẽ chịu trách nhiệm bảo trì trong 3 ngày kể từ khi hoàn thành công việc.</p><p>·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Lắp mới hoặc thay thế linh, phụ kiện, HSP Việt Nam sẽ có trách nhiệm bảo hành theo thời gian niêm yết của nhà cung cấp.</p><p>&nbsp;</p>', '<p>&nbsp;</p>', '<p>&nbsp;</p>', '<p>&nbsp;</p>'),
(5, 'about', '<p>HSP - Home Service Pro là ứng dụng được phát triển để phục vụ các nhu cầu đời sống hộ gia đình.</p><p>Chúng tôi ra mắt ứng dụng trên 2 nền tảng IOS và Android.</p><p>Các dịch vụ đã sẵn sàng phục vụ:</p><ul><li>Giặt ủi</li><li>Giúp việc nhà</li><li>Vệ sinh công nghiệp</li><li>Điều hòa</li><li>Sửa chữa điện, nước dân dụng</li></ul><p>Chúng tôi vẫn đang tiếp tục phát triển và sẽ sớm ra mắt các dịch vụ khác gắn liền với nhu cầu đời sống hàng ngày của Quý khách.&nbsp;</p><p>Xin chân thành cảm ơn Quý khách đã đồng hành và ủng hộ HSP Việt Nam.</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>', '<p>&nbsp;</p>', '<p>&nbsp;</p>', '<p>&nbsp;</p>'),
(6, 'contact', '<p>&nbsp;</p><p>Chúng tôi luôn đồng hành cùng Quý khách</p><p>Liên hệ chúng tôi nếu bạn cần hỗ trợ</p><p>Phone: 0963699652</p><p>Email: support.hsp@gmail.com</p><p>Hỗ trợ cài đặt và hướng dẫn người dùng mới</p><p>Phone: 0963699652</p><p>&nbsp;</p>', '<p>&nbsp;</p>', '<p>&nbsp;</p>', '<p>&nbsp;</p>'),
...
(34, 'suachuaIcon.png', 'Sửa chữa dân dụng', '', '', '', 0, 0, 1),
...
(186, NULL, 'Vật tư', 'Supplies ', '資機材', '기자재', 34, 0, 1),
...
(218, NULL, 'Vật tư', NULL, NULL, NULL, 186, 0, 1);
...
(1, 'Tran Thanh Tuan', '', '779601863_1542162764.jpeg', 'tuantt@gmail.com', '84973619398', '', 1, 2, 1, '84945013456', '84973619398', 0, NULL, '2018-10-29 09:31:53', '2018-11-15 04:15:36'),
(2, '', '', '', '', '14084066195', '', 1, 2, 1, '1', '14084066195', 0, NULL, '2018-10-30 16:13:19', '2018-10-30 16:13:19'),
(3, 'aaaaaa', '', '232683472_1542123964.jpeg', 'aaaa@bbb.cccc', '84902270785', '', 1, 2, 1, '1', '84902270785', 0, NULL, '2018-10-30 18:40:19', '2018-11-13 15:46:04'),
...
(7, 'Nguyen Vu Kien', '', '', 'nvukien@gmail.com', '84945013456', '', 1, 2, 1, '84963699652', '84945013456', 10000, NULL, '2018-10-31 19:13:54', '2018-11-15 04:22:50'),
...
(27, '', '', '', '', '841667950078', '', 1, 2, 1, '1', '841667106118', 0, NULL, '2018-11-13 15:20:14', '2018-11-13 15:20:14'),
(28, '', '', '', '', '845558887445', '', 1, 2, 1, '1', '845558887445', 0, NULL, '2018-11-13 15:22:27', '2018-11-13 15:22:27'),
(29, 'Nguyễn Duy Anh', '', '', '', '84377862955', '', 1, 2, 1, '84978598811', '84377862955', 0, NULL, '2018-11-14 04:20:51', '2018-11-14 04:22:00');
...
(1, '2018-46', 586000, 10000000, 32100, '2018-11-14 02:19:05', '2018-11-15 04:22:50');
