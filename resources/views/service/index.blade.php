            	...
            	<?php
            		...
            		foreach($services as $serviceChild1){
            			...
            			<div class="row service-parent">
            				<img src="http://api.timtruyen.online/images/{{ $serviceChild1->icon }}" width="50px">{{ $serviceChild1->name }}
            			...
            			foreach($listChild1 as $serviceChild2){
            				...
            				<div class="row service-child">
            					<img src="http://api.timtruyen.online/images/{{ $serviceChild1->icon }}" width="50px">{{ $serviceChild2->name }}
            					<div class="group-control">
                            ...
                            foreach($listChild2 as $serviceChild3){
                                ...
                                <div class="row service-child2">
                                    <img src="http://api.timtruyen.online/images/{{ $serviceChild1->icon }}" width="50px">{{ $serviceChild3->name }}
                                    <div class="group-control">
