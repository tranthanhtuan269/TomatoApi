                        ...
                        <div class="col-sm-10">
                            <div class="avatar">
                                ...
                                @if(strlen($package->image) > 0)
                                    <img src="http://api.timtruyen.online/public/images/{{ $package->image }}" id="avatar-image" class="img" width="150" height="150">
                                @else
                                    <img src="http://api.timtruyen.online/public/images/noimage.png" width="150" height="150" id="avatar-image" class="img">
                                @endif
                            </div>
